...
def generate_summaries(model_name, lns, out_file, batch_size=8, device=DEFAULT_DEVICE):
...
def _run_generate():
    ...
    generate_summaries(args.model_name, lns, args.output_path, batch_size=args.bs, device=args.device)
